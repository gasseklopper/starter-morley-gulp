...
function imagesTask(done) {
	...
	return src('./src/assets/img/**/*.{gif,jpg,png,svg}').pipe(
...
// Watch Tasks
const watch_nunjucks = () =>
	watch(paths.nunjucksWatch, series(nunjucksTask, reload))
...
const watch_images = () =>
	watch('./src/assets/img/**/*.*', series(imagesTask, reload))
...
exports.default = series(
	...
	serveTask,
	imagesTask,
	parallel(watch_scss, watch_js, watch_nunjucks, watch_images)
)
